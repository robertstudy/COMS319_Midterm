    ...
    const fishData = [
        {
            fish_name: "Blue Line Grouper",
            size: "large",
            popularity: "",
            imageUrl: "grouper.jpg",
            date_added: "2024-08-18",
            content: "Blue Line Groupers, recognized for their striking blue markings and sleek form, are highly sought-after additions to freshwater aquariums.",
            link: "fish_temp.html?fishId=blgrouper"
        },
        {
            fish_name: "SeaHorse",
            size: "small",
